  ...
  return (
    <section className="py-24 px-4 bg-[#FAFAFA] w-full">
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 lg:gap-12">
        {/* Card 1 */}
        <FadeIn delay={0.1}>
          <div className="flex flex-col h-full bg-white overflow-hidden transition-all duration-500 border border-slate-100 group">
            ...
            <div className="p-8 md:p-10 flex flex-col flex-grow">
              ...
              <div className="mt-auto pt-6 border-t border-slate-100">
                <div className="inline-flex items-center text-sm font-medium text-[#5A7358] bg-[#5A7358]/10 py-2.5 px-5">
          ...
          <div className="flex flex-col h-full bg-white overflow-hidden transition-all duration-500 border border-slate-100 group">
            ...
            <div className="p-8 md:p-10 flex flex-col flex-grow">
              ...
              <div className="mt-auto">
                <a href="#kontakt" className="inline-flex items-center justify-center w-full bg-[#5A7358] text-white px-8 py-4 font-medium transition-all duration-300 hover:bg-[#4a6048] hover:-translate-y-1 group/btn">
                  Umów wizytę
        ...
        <FadeIn delay={0.5}>
          <div className="flex flex-col h-full bg-white overflow-hidden transition-all duration-500 border border-slate-100 group">
            ...
            <div className="p-8 md:p-10 flex flex-col flex-grow">
              ...
              <div className="mt-auto">
                <a href="#o-mnie" className="inline-flex items-center justify-center w-full bg-white border-2 border-[#5A7358] text-[#5A7358] px-8 py-3.5 font-medium transition-all duration-300 hover:bg-[#5A7358] hover:text-white hover:-translate-y-1 group/btn">
                  Poznajmy się
                  <ArrowRight className="w-5 h-5 ml-2 group-hover/btn:translate-x-1 transition-transform" />
                </a>
              </div>
