...
export default function Contact() {
  ...
  return (
    <section id="kontakt" className="py-24 px-4 max-w-7xl mx-auto w-full">
      ...
      <div className="grid lg:grid-cols-2 gap-12 bg-white overflow-hidden border border-slate-100">
          ...
          <div className="p-10 md:p-16 h-full flex flex-col justify-center bg-[#5A7358] text-white">
            ...
            <div className="space-y-8 text-white/90 font-light text-lg">
              <div className="flex items-center group">
                <div className="w-12 h-12 bg-white/10 flex items-center justify-center mr-6 group-hover:bg-white/20 transition-colors">
              ...
              >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full bg-slate-50 border border-slate-200 p-4 focus:outline-none focus:ring-2 focus:ring-[#5A7358]/20 focus:border-[#5A7358] transition-all resize-none"
                  ></textarea>
                </div>
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full bg-[#5A7358] text-white px-8 py-4 text-sm font-semibold tracking-wider hover:bg-[#4a6048] transition-all uppercase disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
